<table class="table table-search-form">
    <tr style="height: 35px">
        ...
        <td>
            <button type="submit" name="search-course" class="btn "><span class="fa fa-search"></span> Search</button>
        </td>
    ...
    if(isset($_POST['search-course'])){
        ...
        <tr style="height: 35px">
            <td colspan="4" style="text-align: left;">
                <a href="admin_course.php" >Close Filter <span class="fa fa-close"  style="color: red"></span>
                </a>
            </td>
        </tr>
        <?php
